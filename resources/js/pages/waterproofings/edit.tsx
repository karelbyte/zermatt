...
import { edit, index } from '@/routes/waterproofings';
...
export default function WaterproofingsEdit({ waterproofing, suppliers }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Impermeabilizantes', href: index().url },
        { title: 'Editar registro', href: edit(waterproofing).url },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar registro de impermeabilizante" />

            <div className="space-y-6">
                <Heading
                    variant="small"
                    title="Editar registro de impermeabilizante"
                    description="Modifica fecha, cantidad, documento o proveedor"
                />

                <Form
                    action={WaterproofingController.update.url({ waterproofing: waterproofing.id })}
                    method="put"
                    className="space-y-6"
                >
                    {({ processing, errors }) => (
                        <>
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    name="date"
                                    type="date"
                                    defaultValue={dateInputValue(waterproofing.date)}
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    step="any"
                                    min="0"
                                    defaultValue={waterproofing.lit ?? ''}
                            ...
                            <div className="grid gap-2">
                                ...
                                <select
                                    ...
                                    name="supplier_id"
                                    className="border-input focus-visible:border-ring focus-visible:ring-ring/50 flex h-9 w-full rounded-md border bg-transparent px-3 py-1 text-base shadow-xs outline-none focus-visible:ring-[3px] md:text-sm"
                                    defaultValue={waterproofing.supplier_id ?? ''}
                                >
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    name="document"
                                    maxLength={255}
                                    defaultValue={waterproofing.document ?? ''}
